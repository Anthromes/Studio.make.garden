...
export const navigateToSSO = () => {
    deleteCookie()
    window.location.href = `https://sso.make.garden/authenticate?redirect_uri=${window.location.origin}${Constants.ROUTES.LOGIN}`
}

export const getLogoutURL = () => 'https://sso.make.garden/logout'